...
| ------------------------------ | -------- | ------- | --------------------------------- |
| Baseline (Logistic Regression) | —        | —       | Базовая модель                    |
| Random Forest                  | —        | —       | Улучшение качества                |
| Gradient Boosting              | —        | —       | Основная экспериментальная модель |
| Лучшая модель                  | —        | —       | Итоговая модель                   |
